...
##AI stuff
#for every mode
#gemini key should be added
client_explain = genai.Client(api_key=" Insert Valid api key")
client_eli5=genai.Client(api_key="Insert Valid api key")
client_debug=genai.Client(api_key="Insert Valid api key")
client_optimize=genai.Client(api_key="Insert valid api key")





#response = client_explain.models.generate_content(
